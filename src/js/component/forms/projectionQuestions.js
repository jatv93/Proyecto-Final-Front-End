...
export const ProjectionQuestions = () => {
	...
	return (
		<Fragment>
			<Modal show={modalShow} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
				...
				<form onSubmit={e => actions.submitTeacherProjectionQuestion(e)}>
					<Modal.Body>
						<textarea
							...
							rows="3"
							required
							onChange={e => actions.addTeacherProjectionQuestion(e.target.value)}
						/>
					</Modal.Body>
					<Modal.Footer>
			...
			<div className="row">
				<div className="col-lg-9 offset-lg-1 mt-3">
					<h4>Proyección del Estudiante</h4>
							...
							<ul key={index}>
								<li>
									...
									<FontAwesomeIcon
										icon={faTrash}
										className="mr-2"
										onClick={() => actions.deleteTeacherProjectionQuestion(index)}
									/>
